...
class TestFormParser(unittest.TestCase):
    def make(self, boundary, config={}):
        ...
        self.f = FormParser(
            "multipart/form-data", on_field, on_file, on_end, boundary=boundary, config=config
        )
    ...
    def test_octet_stream(self):
        ...
        f = FormParser(
            "application/octet-stream", on_field, on_file, on_end=on_end, file_name=b"foo.txt"
        )
